...
(function() {
    ...
    // ===================================
    // Snowfall Effect (Winter Edition)
    // ===================================

    function initSnowfallEffect() {
        ...
        for (let i = 0; i < snowflakeCount; i++) {
            ...
            const startPositionX = Math.random() * 100; // 0 to 100%
        ...
        console.log('Snowfall effect initialized with', snowflakeCount, 'snowflakes');
    }
